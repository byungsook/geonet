...
tf.app.flags.DEFINE_string('data_dir', 'data/dataset1',
                           """Path to data directory.""")
tf.app.flags.DEFINE_integer('image_width', 32,
                            """Image Width.""")
tf.app.flags.DEFINE_integer('image_height', 32,
                            """Image Height.""")
tf.app.flags.DEFINE_integer('batch_size', 8, # 64
...
class BatchManager(object):
    def __init__(self):
        ...
        if FLAGS.num_processors == 1:
            ...
            self._func = partial(train_set, batch=self._batch, x_batch=self.x_batch, y_batch=self.y_batch)
    ...
    def batch(self):
        if FLAGS.num_processors == 1:
            ...
            for i in xrange(FLAGS.batch_size):
                ...
                train_set(i, _batch, self.x_batch, self.y_batch)
...
def train_set(batch_id, batch, x_batch, y_batch):
